...
import sty from "./PlasmicDetailAbout.module.css"; // plasmic-import: O6GXxwJ8FQB73v/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__ijQlO)}>
            <PlasmicImg__
          ...
          <div className={classNames(projectcss.all, sty.column__jgXz)}>
            <h5

...
import PriceCard from "../../PriceCard"; // plasmic-import: JKBfSHkRyq6wpK/component
...
import sty from "./PlasmicPriceSection.module.css"; // plasmic-import: bosK7krf4zDvXC/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__cuQxx)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__wfKpg)}>
          <PriceCard
            borders={["flatLeft"]}
            className={classNames("__wab_instance", sty.priceCard__us3Jl)}
          />
        </div>
        <div className={classNames(projectcss.all, sty.freeBox__qLax5)}>
          <div className={classNames(projectcss.all, sty.freeBox__igenD)}>
            <div
          ...
          <PriceCard
            borders={["flatCenter"]}
            className={classNames("__wab_instance", sty.priceCard__l65Mr)}
          />
        </div>
        <div className={classNames(projectcss.all, sty.freeBox__gxNyR)}>
          <PriceCard
            borders={
            ...
            className={classNames("__wab_instance", sty.priceCard___7AauA)}
          />
        </div>
      </Stack__>
    </div>

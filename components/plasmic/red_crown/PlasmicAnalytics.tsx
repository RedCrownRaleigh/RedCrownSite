...
import sty from "./PlasmicAnalytics.module.css"; // plasmic-import: n519WuZQnL/css
...
function PlasmicAnalytics__RenderFunc(props: {
  ...
  return (
    <Embed
      ...
      code={
        "<!-- Google tag (gtag.js) -->\r\n<script async src=\"https://www.googletagmanager.com/gtag/js?id=G-NF3PYKBV6T\"></script>\r\n<script>\r\n  window.dataLayer = window.dataLayer || [];\r\n  function gtag(){dataLayer.push(arguments);}\r\n  gtag('js', new Date());\r\n\r\n  gtag('config', 'G-NF3PYKBV6T');\r\n</script>"
      }
    />

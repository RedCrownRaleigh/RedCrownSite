...
import sty from "./PlasmicButton.module.css"; // plasmic-import: vE0DoM1TU6rn9z/css
    ...
    <Stack__
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolor_whiteBorder]: hasVariant(
            $state,
            "color",
            "whiteBorder"
          ),
    ...
    >
      {(hasVariant($state, "iconOnly", "iconOnly") ? false : true)
        ? renderPlasmicSlot({
            ...
            className: classNames(sty.slotTargetChildren, {
              ...
              [sty.slotTargetChildrencolor_whiteBorder]: hasVariant(
                $state,
                "color",
                "whiteBorder"
              ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__q23Ot)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__rgZOj)}
                role={"img"}
              />
            ),
